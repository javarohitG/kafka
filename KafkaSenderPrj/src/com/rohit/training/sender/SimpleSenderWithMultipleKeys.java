...
public class SimpleSenderWithMultipleKeys {
public static void main(String[] args) {
	...
	for(int i=51;i<=60;i++) {
		...
		ProducerRecord<String, String> record=new ProducerRecord<String, String>(topic, "sixth-key", 
				"This is a test message "+i);
		producer.send(record);
	}
	...
	for(int i=61;i<=70;i++) {
		...
		ProducerRecord<String, String> record=new ProducerRecord<String, String>(topic, "seventh-key", 
				"This is a test message "+i);
		producer.send(record);
	}
